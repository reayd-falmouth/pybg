...
# from pybg.rl.game.game import Game, ALL_ACTIONS
# from unittest.mock import MagicMock
# from pybg.rl.game.game import Game, ALL_ACTIONS
# from pybg.rl.game.board import Point, Board
#
...
#     monkeypatch.setattr("pybg.rl.game.game.opening_roll", lambda: [6, 1])
#     with patch("pybg.rl.game.game.Board", return_value=mock_board):
...
#     monkeypatch.setattr("pybg.rl.game.game.opening_roll", lambda: [1, 6])
#     with patch("pybg.rl.game.game.Board", return_value=mock_board):
#         game = Game(dummy_player, dummy_player)
